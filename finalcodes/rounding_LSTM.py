...
# This function computes the gradients of the binary weights
def compute_rnn_grads(loss,network):
	...
	for layer in layers:
		...
		if params:
			for param in params:
				print(param.name)
				if param.name=='W_in_to_ingate':
					grads.append(theano.grad(loss, wrt=layer.W_in_to_ingate_d))
				elif param.name=='W_in_to_forgetgate':
					grads.append(theano.grad(loss, wrt=layer.W_in_to_forgetgate_d))
				elif param.name=='W_in_to_cell':
					grads.append(theano.grad(loss, wrt=layer.W_in_to_cell_d))
				elif param.name=='W_in_to_outgate':
					grads.append(theano.grad(loss, wrt=layer.W_in_to_outgate_d))
				elif param.name=='W_hid_to_ingate':
					grads.append(theano.grad(loss, wrt=layer.W_hid_to_ingate_d))
				elif param.name=='W_hid_to_forgetgate':
					grads.append(theano.grad(loss, wrt=layer.W_hid_to_forgetgate_d))
				elif param.name=='W_hid_to_cell':
					grads.append(theano.grad(loss, wrt=layer.W_hid_to_cell_d))
				elif param.name=='W_hid_to_outgate':
					grads.append(theano.grad(loss, wrt=layer.W_hid_to_outgate_d))
				elif param.name=='b_ingate':
					grads.append(theano.grad(loss, wrt=layer.b_ingate_d))
				elif param.name=='b_forgetgate':
					grads.append(theano.grad(loss, wrt=layer.b_forgetgate_d))
				elif param.name=='b_cell':
					grads.append(theano.grad(loss, wrt=layer.b_cell_d))
				elif param.name=='b_outgate':
					grads.append(theano.grad(loss, wrt=layer.b_outgate_d))
